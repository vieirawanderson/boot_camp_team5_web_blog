...
<html  lang="en">
  <head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{ URL::asset('bootstrap/css/bootstrap.min.css') }}" type="text/css" rel="stylesheet" />
    <!-- Plugins CSS -->
    <link href="{{ URL::asset('assets/css/normalize.css') }}" type="text/css" rel="stylesheet" />
    <link href="{{ URL::asset('assets/css/iline-icons.css') }}" type="text/css" rel="stylesheet" />
    ...
    <link href="{{ URL::asset('assets/css/owl.theme.css') }}" type="text/css" rel="stylesheet" />
    <link href="{{ URL::asset('assets/css/owl.transitions.css') }}" type="text/css" rel="stylesheet" />
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
              <img src="{{ URL::asset('assets/images/logo.png') }}" alt="Fallone logo" class="img-responsive" style="padding-top:15px;padding-right:15px;"/>
            </a>
          </div>
...
<!-- Back to top -->
    ...
    <!-- Include js plugin -->
    <script src="{{ URL::asset('assets/js/libs/jquery-1.11.2.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jqBootstrapValidation.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/imagesloaded.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ URL::asset('bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/isotope.pkgd.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/ParallaxScrolling.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jquery.mailchimp.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/wow.min.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/owl.carousel.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jquery.fittext.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jquery.lettering.js') }}"></script>
    <script src="{{ URL::asset('assets/js/libs/jquery.textillate.js') }}"></script>
